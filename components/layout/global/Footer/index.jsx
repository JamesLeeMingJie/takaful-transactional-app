  ...
  return (
    <footer className="bg-background-primary z-[1]">
      <div className="text-center text-font-secondary py-6 flex flex-col justify-center w-10/12 mx-auto relative">
        <p className="pb-0">Security | Terms & Conditions | Privacy Notice | Customer Service Charter</p>
        <p className="pb-0">Managed by © <span className="text-[#2194FF] underline">Syarikat Takaful Malaysia Keluarga Berhad</span> 198401019089 (131646-K).</p>
        <p className="pb-0">Licensed under the Islamic Financial Services Act 2013 and regulated by Bank Negara Malaysia.</p>
