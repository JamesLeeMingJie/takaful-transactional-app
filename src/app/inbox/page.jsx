    ...
    return (
        <main>
            ...
            <section className="pb-12">
                <div className="w-10/12 mx-auto grid grid-cols-1 gap-y-7 px-4 pt-7 lg:pb-3 lg:pt-8 lg:px-8 lg:grid-cols-[40%_50%] gap-x-16 relative shadow-lg bg-primary-white bg-opacity-0 border-transparent rounded-2xl">
                        ...
                        <div className="grid grid-cols-[1fr_2fr_2fr_1fr] ">
                                ...
                                <div className="grid grid-cols-[1fr_2fr_2fr_2fr] gap-4">
                                    <div className="col-span-1">
                                        <div className="flex items-center gap-3">
                                            <span className="inline-block rounded-full bg-[#3876BF] w-2 h-2"></span>
                                            <Image src={profilePic1} alt="" />
                                        </div>
                                    </div>
                                    <div className="col-span-2">
                                        <div className="flex items-center space-x-2">
                                            <div className="text-lg font-bold pb-1 text-font-primary">
                                                Claim Submitted
                                            </div>
                            ...
                            <div className="col-span-4 border-b-[1px] border-b-secondary-gray px-2 py-6">
                                <div className="grid grid-cols-[1fr_2fr_2fr_2fr] gap-4">
                                    ...
                                    <div className=" col-span-2">
                                        <div className="flex items-center space-x-2">
                                            <div className="text-lg font-medium pb-1 text-font-primary">
                                                Payment Successful
                                            </div>
                                        </div>
